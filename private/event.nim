...
type 
  WxEventFilter* {.importcpp: "wxEventFilter", header: "<wx/wx.h>".} = object 
...
type 
  WxEventTypeTag* {.importcpp: "wxEventTypeTag", header: "<wx/wx.h>".}[T] = object 
  

proc constructwxEventTypeTag*[T](`type`: WxEventType): WxEventTypeTag[T] {.
    cdecl, constructor, importcpp: "wxEventTypeTag(@)", header: "<wx/wx.h>".}
...
var wxEVT_NULL* {.importcpp: "wxEVT_NULL", header: "<wx/wx.h>".}: WxEventType

var wxEVT_FIRST* {.importcpp: "wxEVT_FIRST", header: "<wx/wx.h>".}: WxEventType

var wxEVT_USER_FIRST* {.importcpp: "wxEVT_USER_FIRST", header: "<wx/wx.h>".}: WxEventType
...
type 
  WxEvent* {.importcpp: "wxEvent", header: "<wx/wx.h>".} = object of WxObject
...
proc isMatching*(this: WxEventFunctor; functor: WxEventFunctor): bool {.
    noSideEffect, cdecl, importcpp: "IsMatching", header: "<wx/wx.h>".}
proc getEvtHandler*(this: WxEventFunctor): ptr WxEvtHandler {.noSideEffect, 
    cdecl, importcpp: "GetEvtHandler", header: "<wx/wx.h>".}
proc getEvtMethod*(this: WxEventFunctor): WxEventFunction {.noSideEffect, cdecl, 
    importcpp: "GetEvtMethod", header: "<wx/wx.h>".}

type 
  WxObjectEventFunctor* {.importcpp: "wxObjectEventFunctor", header: "<wx/wx.h>".} = object of WxEventFunctor
  

proc constructwxObjectEventFunctor*(`method`: WxObjectEventFunction; 
                                    handler: ptr WxEvtHandler): WxObjectEventFunctor {.
    cdecl, constructor, importcpp: "wxObjectEventFunctor(@)", 
    header: "<wx/wx.h>".}
proc `()`*(this: var WxObjectEventFunctor; handler: ptr WxEvtHandler; 
           event: var WxEvent) {.cdecl, importcpp: "#(@)", header: "<wx/wx.h>".}
...
proc constructwxEventFunctorMethod*[EventTag, Class, EventArg, EventHandler](
    ...
    importcpp: "wxEventFunctorMethod(@)", header: "<wx/wx.h>".}
...
proc getEvtMethod*[EventTag, Class, EventArg, EventHandler](
    ...
    noSideEffect, cdecl, importcpp: "GetEvtMethod", header: "<wx/wx.h>".}

type 
  WxEventFunctorFunction* {.importcpp: "wxEventFunctorFunction", 
                            header: "<wx/wx.h>".}[EventTag, EventArg] = object of WxEventFunctor
...
proc constructwxEventFunctorFunction*[EventTag, EventArg](
    ...
    EventTag, EventArg] {.cdecl, constructor, 
                          importcpp: "wxEventFunctorFunction(@)", 
                          header: "<wx/wx.h>".}
...
proc isMatching*[EventTag, EventArg](this: WxEventFunctorFunction[EventTag, 
    ...
    importcpp: "IsMatching", header: "<wx/wx.h>".}
type 
  WxEventFunctorFunctor* {.importcpp: "wxEventFunctorFunctor", 
                           header: "<wx/wx.h>".}[EventTag, Functor] = object of WxEventFunctor
...
proc constructwxEventFunctorFunctor*[EventTag, Functor](handler: Functor): WxEventFunctorFunctor[
    EventTag, Functor] {.cdecl, constructor, 
                         importcpp: "wxEventFunctorFunctor(@)", 
                         header: "<wx/wx.h>".}
...
proc wxMakeEventFunctor*[EventTag, EventArg](a2: EventTag; 
    ...
    EventArg] {.cdecl, importcpp: "wxMakeEventFunctor(@)", header: "<wx/wx.h>".}
...
proc wxNewEventFunctor*[EventTag, Class, EventArg, EventHandler](a2: EventTag; 
    ...
    importcpp: "wxNewEventFunctor(@)", header: "<wx/wx.h>".}
proc wxMakeEventFunctor*[EventTag, Class, EventArg, EventHandler](a2: EventTag; 
    ...
    EventTag, Class, EventArg, EventHandler] {.cdecl, 
    importcpp: "wxMakeEventFunctor(@)", header: "<wx/wx.h>".}
...
proc wxNewEventTableFunctor*[EventTag, Class, EventArg](a2: EventTag; 
    ...
    Class] {.cdecl, importcpp: "wxNewEventTableFunctor(@)", header: "<wx/wx.h>".}
...
proc constructwxEventProcessInHandlerOnly*(event: var WxEvent; 
    ...
    constructor, importcpp: "wxEventProcessInHandlerOnly(@)", 
    header: "<wx/wx.h>".}
proc destroywxEventProcessInHandlerOnly*(this: var WxEventProcessInHandlerOnly) {.
    cdecl, importcpp: "#.~wxEventProcessInHandlerOnly()", header: "<wx/wx.h>".}
type 
...
proc constructwxEventBasicPayloadMixin*(): WxEventBasicPayloadMixin {.cdecl, 
    constructor, importcpp: "wxEventBasicPayloadMixin(@)", header: "<wx/wx.h>".}
...
proc setInt*(this: var WxEventBasicPayloadMixin; i: cint) {.cdecl, 
    importcpp: "SetInt", header: "<wx/wx.h>".}
proc getInt*(this: WxEventBasicPayloadMixin): cint {.noSideEffect, cdecl, 
    importcpp: "GetInt", header: "<wx/wx.h>".}
proc setExtraLong*(this: var WxEventBasicPayloadMixin; extraLong: clong) {.
    cdecl, importcpp: "SetExtraLong", header: "<wx/wx.h>".}
proc getExtraLong*(this: WxEventBasicPayloadMixin): clong {.noSideEffect, cdecl, 
    importcpp: "GetExtraLong", header: "<wx/wx.h>".}
type 
  WxEventAnyPayloadMixin* {.importcpp: "wxEventAnyPayloadMixin", 
                            header: "<wx/wx.h>".} = object of WxEventBasicPayloadMixin
  

proc constructwxEventAnyPayloadMixin*(): WxEventAnyPayloadMixin {.cdecl, 
    constructor, importcpp: "wxEventAnyPayloadMixin(@)", header: "<wx/wx.h>".}
...
type 
  WxThreadEvent* {.importcpp: "wxThreadEvent", header: "<wx/wx.h>".} = object of WxEvent
  

proc constructwxThreadEvent*(eventType: WxEventType; id = wxID_ANY): WxThreadEvent {.
    cdecl, constructor, importcpp: "wxThreadEvent(@)", header: "<wx/wx.h>".}
proc constructwxThreadEvent*(event: WxThreadEvent): WxThreadEvent {.cdecl, 
    constructor, importcpp: "wxThreadEvent(@)", header: "<wx/wx.h>".}
...
proc getEventCategory*(this: WxThreadEvent): WxEventCategory {.noSideEffect, 
    cdecl, importcpp: "GetEventCategory", header: "<wx/wx.h>".}

type 
  WxAsyncMethodCallEvent* {.importcpp: "wxAsyncMethodCallEvent", 
                            header: "<wx/wx.h>".} = object of WxEvent
  

proc constructwxAsyncMethodCallEvent*(`object`: ptr WxObject): WxAsyncMethodCallEvent {.
    cdecl, constructor, importcpp: "wxAsyncMethodCallEvent(@)", 
    header: "<wx/wx.h>".}
...
type 
  WxAsyncMethodCallEvent0* {.importcpp: "wxAsyncMethodCallEvent0", 
                             header: "<wx/wx.h>".}[T] = object of WxAsyncMethodCallEvent
...
type 
  WxAsyncMethodCallEvent2* {.importcpp: "wxAsyncMethodCallEvent2", 
                             header: "<wx/wx.h>".}[T, T1, T2] = object of WxAsyncMethodCallEvent
...
type 
  WxClientData* {.importcpp: "wxClientData", header: "<wx/wx.h>", inheritable.} = object 
  
  WxCommandEvent* {.importcpp: "wxCommandEvent", header: "<wx/wx.h>".} = object of WxEvent
  

proc constructwxCommandEvent*(commandType: WxEventType = wxEVT_NULL; 
                              winid: cint = 0): WxCommandEvent {.cdecl, 
    constructor, importcpp: "wxCommandEvent(@)", header: "<wx/wx.h>".}
...
proc isSelection*(this: WxCommandEvent): bool {.noSideEffect, cdecl, 
    importcpp: "IsSelection", header: "<wx/wx.h>".}
...
type 
  WxNotifyEvent* {.importcpp: "wxNotifyEvent", header: "<wx/wx.h>".} = object of WxCommandEvent
  

proc constructwxNotifyEvent*(commandType: WxEventType = wxEVT_NULL; 
                             winid: cint = 0): WxNotifyEvent {.cdecl, 
    constructor, importcpp: "wxNotifyEvent(@)", header: "<wx/wx.h>".}
proc constructwxNotifyEvent*(event: WxNotifyEvent): WxNotifyEvent {.cdecl, 
    constructor, importcpp: "wxNotifyEvent(@)", header: "<wx/wx.h>".}
proc veto*(this: var WxNotifyEvent) {.cdecl, importcpp: "Veto", 
                                      header: "<wx/wx.h>".}
proc allow*(this: var WxNotifyEvent) {.cdecl, importcpp: "Allow", 
                                       header: "<wx/wx.h>".}
proc isAllowed*(this: WxNotifyEvent): bool {.noSideEffect, cdecl, 
    importcpp: "IsAllowed", header: "<wx/wx.h>".}
proc clone*(this: WxNotifyEvent): ptr WxEvent {.noSideEffect, cdecl, 
    importcpp: "Clone", header: "<wx/wx.h>".}

type 
  WxScrollEvent* {.importcpp: "wxScrollEvent", header: "<wx/wx.h>".} = object of WxCommandEvent
  

proc constructwxScrollEvent*(commandType: WxEventType = wxEVT_NULL; 
                             winid: cint = 0; pos: cint = 0; orient: cint = 0): WxScrollEvent {.
    cdecl, constructor, importcpp: "wxScrollEvent(@)", header: "<wx/wx.h>".}
...
type 
  WxScrollWinEvent* {.importcpp: "wxScrollWinEvent", header: "<wx/wx.h>".} = object of WxEvent
  

proc constructwxScrollWinEvent*(commandType: WxEventType = wxEVT_NULL; 
                                pos: cint = 0; orient: cint = 0): WxScrollWinEvent {.
    cdecl, constructor, importcpp: "wxScrollWinEvent(@)", header: "<wx/wx.h>".}
...
type 
  WxMouseWheelAxis* {.size: sizeof(cint), 
                      importcpp: "wxHelpEvent::wxMouseWheelAxis", 
                      header: "<wx/wx.h>".} = enum 
    wxMOUSE_WHEEL_VERTICAL, wxMOUSE_WHEEL_HORIZONTAL


type 
  WxMouseEvent* {.importcpp: "wxMouseEvent", header: "<wx/wx.h>".} = object of WxEvent
...
proc constructwxMouseEvent*(mouseType: WxEventType = wxEVT_NULL): WxMouseEvent {.
    cdecl, constructor, importcpp: "wxMouseEvent(@)", header: "<wx/wx.h>".}
proc constructwxMouseEvent*(event: WxMouseEvent): WxMouseEvent {.cdecl, 
    constructor, importcpp: "wxMouseEvent(@)", header: "<wx/wx.h>".}
...
type 
  WxSetCursorEvent* {.importcpp: "wxSetCursorEvent", header: "<wx/wx.h>".} = object of WxEvent
  

proc constructwxSetCursorEvent*(x: WxCoord = 0; y: WxCoord = 0): WxSetCursorEvent {.
    cdecl, constructor, importcpp: "wxSetCursorEvent(@)", header: "<wx/wx.h>".}
...
type 
  WxChar* = uint32
  WxKeyEvent* {.importcpp: "wxKeyEvent", header: "<wx/wx.h>".} = object of WxEvent
...
proc constructwxKeyEvent*(keyType: WxEventType = wxEVT_NULL): WxKeyEvent {.
    cdecl, constructor, importcpp: "wxKeyEvent(@)", header: "<wx/wx.h>".}
proc constructwxKeyEvent*(evt: WxKeyEvent): WxKeyEvent {.cdecl, constructor, 
    importcpp: "wxKeyEvent(@)", header: "<wx/wx.h>".}
...
proc doAllowNextEvent*(this: var WxKeyEvent) {.cdecl, 
    importcpp: "DoAllowNextEvent", header: "<wx/wx.h>".}
proc isNextEventAllowed*(this: WxKeyEvent): bool {.noSideEffect, cdecl, 
    importcpp: "IsNextEventAllowed", header: "<wx/wx.h>".}
...
proc setRect*(this: var WxSizeEvent; rect: WxRect) {.cdecl, 
    importcpp: "SetRect", header: "<wx/wx.h>".}
proc clone*(this: WxSizeEvent): ptr WxEvent {.noSideEffect, cdecl, 
    importcpp: "Clone", header: "<wx/wx.h>".}

type 
  WxMoveEvent* {.importcpp: "wxMoveEvent", header: "<wx/wx.h>".} = object of WxEvent
  

proc constructwxMoveEvent*(): WxMoveEvent {.cdecl, constructor, 
    importcpp: "wxMoveEvent(@)", header: "<wx/wx.h>".}
proc constructwxMoveEvent*(pos: WxPoint; winid: cint = 0): WxMoveEvent {.cdecl, 
    constructor, importcpp: "wxMoveEvent(@)", header: "<wx/wx.h>".}
...
proc setWindow*(this: var WxFocusEvent; win: ptr WxWindow) {.cdecl, 
    importcpp: "SetWindow", header: "<wx/wx.h>".}
proc clone*(this: WxFocusEvent): ptr WxEvent {.noSideEffect, cdecl, 
    importcpp: "Clone", header: "<wx/wx.h>".}

type 
  WxChildFocusEvent* {.importcpp: "wxChildFocusEvent", header: "<wx/wx.h>".} = object of WxCommandEvent
  

proc constructwxChildFocusEvent*(win: ptr WxWindow = nil): WxChildFocusEvent {.
    cdecl, constructor, importcpp: "wxChildFocusEvent(@)", header: "<wx/wx.h>".}
...
type 
  WxActivateEvent* {.importcpp: "wxActivateEvent", header: "<wx/wx.h>".} = object of WxEvent
...
type 
  WxIconizeEvent* {.importcpp: "wxIconizeEvent", header: "<wx/wx.h>".} = object of WxEvent
  

proc constructwxIconizeEvent*(winid: cint = 0; iconized: bool = true): WxIconizeEvent {.
    cdecl, constructor, importcpp: "wxIconizeEvent(@)", header: "<wx/wx.h>".}
proc constructwxIconizeEvent*(event: WxIconizeEvent): WxIconizeEvent {.cdecl, 
    constructor, importcpp: "wxIconizeEvent(@)", header: "<wx/wx.h>".}
proc isIconized*(this: WxIconizeEvent): bool {.noSideEffect, cdecl, 
    importcpp: "IsIconized", header: "<wx/wx.h>".}
proc clone*(this: WxIconizeEvent): ptr WxEvent {.noSideEffect, cdecl, 
    importcpp: "Clone", header: "<wx/wx.h>".}

type 
  WxMaximizeEvent* {.importcpp: "wxMaximizeEvent", header: "<wx/wx.h>".} = object of WxEvent
  

proc constructwxMaximizeEvent*(winid: cint = 0): WxMaximizeEvent {.cdecl, 
    constructor, importcpp: "wxMaximizeEvent(@)", header: "<wx/wx.h>".}
...
type 
  WxJoystickEvent* {.importcpp: "wxJoystickEvent", header: "<wx/wx.h>".} = object of WxEvent
...
proc constructwxJoystickEvent*(`type`: WxEventType = wxEVT_NULL; 
    ...
    constructor, importcpp: "wxJoystickEvent(@)", header: "<wx/wx.h>".}
...
proc constructwxDropFilesEvent*(`type`: WxEventType = wxEVT_NULL; 
    ...
    cdecl, constructor, importcpp: "wxDropFilesEvent(@)", header: "<wx/wx.h>".}
...
proc destroywxDropFilesEvent*(this: var WxDropFilesEvent) {.cdecl, 
    importcpp: "#.~wxDropFilesEvent()", header: "<wx/wx.h>".}
...
proc setUpdateInterval*(updateInterval: clong) {.cdecl, 
    importcpp: "wxUpdateUIEvent::SetUpdateInterval(@)", header: "<wx/wx.h>".}
...
proc canUpdate*(win: ptr WxWindowBase): bool {.cdecl, 
    importcpp: "wxUpdateUIEvent::CanUpdate(@)", header: "<wx/wx.h>".}
...
proc constructwxSysColourChangedEvent*(): WxSysColourChangedEvent {.cdecl, 
    constructor, importcpp: "wxSysColourChangedEvent(@)", header: "<wx/wx.h>".}
...
proc getCapturedWindow*(this: WxMouseCaptureChangedEvent): ptr WxWindow {.
    noSideEffect, cdecl, importcpp: "GetCapturedWindow", header: "<wx/wx.h>".}
...
type 
  WxDisplayChangedEvent* {.importcpp: "wxDisplayChangedEvent", 
                           header: "<wx/wx.h>".} = object of WxEvent
  

proc constructwxDisplayChangedEvent*(): WxDisplayChangedEvent {.cdecl, 
    constructor, importcpp: "wxDisplayChangedEvent(@)", header: "<wx/wx.h>".}
proc clone*(this: WxDisplayChangedEvent): ptr WxEvent {.noSideEffect, cdecl, 
    importcpp: "Clone", header: "<wx/wx.h>".}

type 
  WxPaletteChangedEvent* {.importcpp: "wxPaletteChangedEvent", 
                           header: "<wx/wx.h>".} = object of WxEvent
...
proc setChangedWindow*(this: var WxPaletteChangedEvent; win: ptr WxWindow) {.
    cdecl, importcpp: "SetChangedWindow", header: "<wx/wx.h>".}
proc getChangedWindow*(this: WxPaletteChangedEvent): ptr WxWindow {.
    noSideEffect, cdecl, importcpp: "GetChangedWindow", header: "<wx/wx.h>".}
proc clone*(this: WxPaletteChangedEvent): ptr WxEvent {.noSideEffect, cdecl, 
    importcpp: "Clone", header: "<wx/wx.h>".}

type 
  WxQueryNewPaletteEvent* {.importcpp: "wxQueryNewPaletteEvent", 
                            header: "<wx/wx.h>".} = object of WxEvent
...
proc setPaletteRealized*(this: var WxQueryNewPaletteEvent; realized: bool) {.
    cdecl, importcpp: "SetPaletteRealized", header: "<wx/wx.h>".}
proc getPaletteRealized*(this: WxQueryNewPaletteEvent): bool {.noSideEffect, 
    cdecl, importcpp: "GetPaletteRealized", header: "<wx/wx.h>".}
proc clone*(this: WxQueryNewPaletteEvent): ptr WxEvent {.noSideEffect, cdecl, 
    importcpp: "Clone", header: "<wx/wx.h>".}

type 
  WxNavigationKeyEvent* {.importcpp: "wxNavigationKeyEvent", header: "<wx/wx.h>".} = object of WxEvent
...
type 
  WxWindowCreateEvent* {.importcpp: "wxWindowCreateEvent", header: "<wx/wx.h>".} = object of WxCommandEvent
  

proc constructwxWindowCreateEvent*(win: ptr WxWindow = nil): WxWindowCreateEvent {.
    cdecl, constructor, importcpp: "wxWindowCreateEvent(@)", header: "<wx/wx.h>".}
...
proc clone*(this: WxWindowCreateEvent): ptr WxEvent {.noSideEffect, cdecl, 
    importcpp: "Clone", header: "<wx/wx.h>".}
type 
  WxWindowDestroyEvent* {.importcpp: "wxWindowDestroyEvent", header: "<wx/wx.h>".} = object of WxCommandEvent
  

proc constructwxWindowDestroyEvent*(win: ptr WxWindow = nil): WxWindowDestroyEvent {.
    cdecl, constructor, importcpp: "wxWindowDestroyEvent(@)", 
    header: "<wx/wx.h>".}
...
type 
  WxHelpEvent* {.importcpp: "wxHelpEvent", header: "<wx/wx.h>".} = object of WxCommandEvent
  
  Origin* {.size: sizeof(cint), importcpp: "wxHelpEvent::Origin", 
            header: "<wx/wx.h>".} = enum 
...
proc constructwxHelpEvent*(event: WxHelpEvent): WxHelpEvent {.cdecl, 
    constructor, importcpp: "wxHelpEvent(@)", header: "<wx/wx.h>".}
...
proc getLink*(this: WxHelpEvent): WxString {.noSideEffect, cdecl, 
    importcpp: "GetLink", header: "<wx/wx.h>".}
proc setLink*(this: var WxHelpEvent; link: WxString) {.cdecl, 
    importcpp: "SetLink", header: "<wx/wx.h>".}
...
proc setTarget*(this: var WxHelpEvent; target: WxString) {.cdecl, 
    importcpp: "SetTarget", header: "<wx/wx.h>".}
proc clone*(this: WxHelpEvent): ptr WxEvent {.noSideEffect, cdecl, 
    importcpp: "Clone", header: "<wx/wx.h>".}
proc getOrigin*(this: WxHelpEvent): Origin {.noSideEffect, cdecl, 
    importcpp: "GetOrigin", header: "<wx/wx.h>".}
proc setOrigin*(this: var WxHelpEvent; origin: Origin) {.cdecl, 
    importcpp: "SetOrigin", header: "<wx/wx.h>".}

type 
  WxClipboardTextEvent* {.importcpp: "wxClipboardTextEvent", header: "<wx/wx.h>".} = object of WxCommandEvent
...
type 
  WxContextMenuEvent* {.importcpp: "wxContextMenuEvent", header: "<wx/wx.h>".} = object of WxCommandEvent
...
type 
  WxEventTableEntryBase* {.importcpp: "wxEventTableEntryBase", 
                           header: "<wx/wx.h>", inheritable.} = object 
...
proc constructwxEventTableEntryBase*(winid: cint; idLast: cint; 
    ...
    cdecl, constructor, importcpp: "wxEventTableEntryBase(@)", 
    header: "<wx/wx.h>".}
...
proc destroywxEventTableEntryBase*(this: var WxEventTableEntryBase) {.cdecl, 
    importcpp: "#.~wxEventTableEntryBase()", header: "<wx/wx.h>".}

type 
  WxEventTableEntry* {.importcpp: "wxEventTableEntry", header: "<wx/wx.h>".} = object of WxEventTableEntryBase
...
proc constructwxEventTableEntry*(evType: cint; winid: cint; idLast: cint; 
    ...
    cdecl, constructor, importcpp: "wxEventTableEntry(@)", header: "<wx/wx.h>".}

type 
  WxDynamicEventTableEntry* {.importcpp: "wxDynamicEventTableEntry", 
                              header: "<wx/wx.h>".} = object of WxEventTableEntryBase
    mEventType* {.importc: "m_eventType".}: cint
...
proc constructwxDynamicEventTableEntry*(evType: cint; winid: cint; idLast: cint; 
    ...
    cdecl, constructor, importcpp: "wxDynamicEventTableEntry(@)", 
    header: "<wx/wx.h>".}

type 
  WxEventTable* {.importcpp: "wxEventTable", header: "<wx/wx.h>".} = object 
...
proc connect*(this: var WxEvtHandler; winid: cint; lastId: cint; 
    ...
    cdecl, importcpp: "Connect", header: "<wx/wx.h>".}
...
proc disconnect*(this: var WxEvtHandler; winid: cint; lastId: cint; 
    ...
    cdecl, importcpp: "Disconnect", header: "<wx/wx.h>".}
...
proc disconnect*(this: var WxEvtHandler; eventType: WxEventType; 
    ...
    importcpp: "Disconnect", header: "<wx/wx.h>".}
...
proc getDynamicEventTable*(this: WxEvtHandler): ptr WxList {.noSideEffect, 
    cdecl, importcpp: "GetDynamicEventTable", header: "<wx/wx.h>".}
proc setClientObject*(this: var WxEvtHandler; data: ptr WxClientData) {.cdecl, 
    importcpp: "SetClientObject", header: "<wx/wx.h>".}
...
proc processEventIfMatchesId*(tableEntry: WxEventTableEntryBase; 
    ...
    cdecl, importcpp: "wxEvtHandler::ProcessEventIfMatchesId(@)", 
    header: "<wx/wx.h>".}
proc searchEventTable*(this: var WxEvtHandler; table: var WxEventTable; 
                       event: var WxEvent): bool {.cdecl, 
    importcpp: "SearchEventTable", header: "<wx/wx.h>".}
proc searchDynamicEventTable*(this: var WxEvtHandler; event: var WxEvent): bool {.
    cdecl, importcpp: "SearchDynamicEventTable", header: "<wx/wx.h>".}
proc clearEventHashTable*(this: var WxEvtHandler) {.cdecl, 
    importcpp: "ClearEventHashTable", header: "<wx/wx.h>".}
proc onSinkDestroyed*(this: var WxEvtHandler; sink: ptr WxEvtHandler) {.cdecl, 
    importcpp: "OnSinkDestroyed", header: "<wx/wx.h>".}

type 
  WxTrackerNode* {.importcpp: "wxTrackerNode", header: "<wx/wx.h>", inheritable.} = object 
  
  WxEventConnectionRef* {.importcpp: "wxEventConnectionRef", header: "<wx/wx.h>".} = object of WxTrackerNode
  

proc constructwxEventConnectionRef*(): WxEventConnectionRef {.cdecl, 
    constructor, importcpp: "wxEventConnectionRef(@)", header: "<wx/wx.h>".}
proc constructwxEventConnectionRef*(src: ptr WxEvtHandler; 
                                    sink: ptr WxEvtHandler): WxEventConnectionRef {.
    cdecl, constructor, importcpp: "wxEventConnectionRef(@)", 
    header: "<wx/wx.h>".}
proc onObjectDestroy*(this: var WxEventConnectionRef) {.cdecl, 
    importcpp: "OnObjectDestroy", header: "<wx/wx.h>".}
proc toEventConnection*(this: var WxEventConnectionRef): ptr WxEventConnectionRef {.
    cdecl, importcpp: "ToEventConnection", header: "<wx/wx.h>".}
...
proc wxPostEvent*(dest: ptr WxEvtHandler; event: WxEvent) {.cdecl, 
    importcpp: "wxPostEvent(@)", header: "<wx/wx.h>".}

proc wxQueueEvent*(dest: ptr WxEvtHandler; event: ptr WxEvent) {.cdecl, 
    importcpp: "wxQueueEvent(@)", header: "<wx/wx.h>".}

proc wxFindFocusDescendant*(ancestor: ptr WxWindow): ptr WxWindow {.cdecl, 
    importcpp: "wxFindFocusDescendant(@)", header: "<wx/wx.h>".}

var wxEVT_BUTTON* {.importcpp: "wxEVT_BUTTON", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxCommandEvent]

var wxEVT_CHECKBOX* {.importcpp: "wxEVT_CHECKBOX", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxCommandEvent]

var wxEVT_CHOICE* {.importcpp: "wxEVT_CHOICE", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxCommandEvent]

var wxEVT_LISTBOX* {.importcpp: "wxEVT_LISTBOX", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxCommandEvent]

var wxEVT_LISTBOX_DCLICK* {.importcpp: "wxEVT_LISTBOX_DCLICK", 
                            header: "<wx/wx.h>".}: WxEventTypeTag[WxCommandEvent]

var wxEVT_CHECKLISTBOX* {.importcpp: "wxEVT_CHECKLISTBOX", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxCommandEvent]

var wxEVT_MENU* {.importcpp: "wxEVT_MENU", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxCommandEvent]

var wxEVT_SLIDER* {.importcpp: "wxEVT_SLIDER", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxCommandEvent]

var wxEVT_RADIOBOX* {.importcpp: "wxEVT_RADIOBOX", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxCommandEvent]

var wxEVT_RADIOBUTTON* {.importcpp: "wxEVT_RADIOBUTTON", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxCommandEvent]


var wxEVT_SCROLLBAR* {.importcpp: "wxEVT_SCROLLBAR", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxCommandEvent]

var wxEVT_VLBOX* {.importcpp: "wxEVT_VLBOX", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxCommandEvent]

var wxEVT_COMBOBOX* {.importcpp: "wxEVT_COMBOBOX", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxCommandEvent]

var wxEVT_TOOL_RCLICKED* {.importcpp: "wxEVT_TOOL_RCLICKED", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxCommandEvent]

var wxEVT_TOOL_DROPDOWN* {.importcpp: "wxEVT_TOOL_DROPDOWN", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxCommandEvent]

var wxEVT_TOOL_ENTER* {.importcpp: "wxEVT_TOOL_ENTER", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxCommandEvent]
...
var wxEVT_THREAD* {.importcpp: "wxEVT_THREAD", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxThreadEvent]
...
var wxEVT_LEFT_DOWN* {.importcpp: "wxEVT_LEFT_DOWN", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxMouseEvent]

var wxEVT_LEFT_UP* {.importcpp: "wxEVT_LEFT_UP", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxMouseEvent]

var wxEVT_MIDDLE_DOWN* {.importcpp: "wxEVT_MIDDLE_DOWN", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxMouseEvent]

var wxEVT_MIDDLE_UP* {.importcpp: "wxEVT_MIDDLE_UP", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxMouseEvent]

var wxEVT_RIGHT_DOWN* {.importcpp: "wxEVT_RIGHT_DOWN", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxMouseEvent]

var wxEVT_RIGHT_UP* {.importcpp: "wxEVT_RIGHT_UP", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxMouseEvent]

var wxEVT_MOTION* {.importcpp: "wxEVT_MOTION", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxMouseEvent]

var wxEVT_ENTER_WINDOW* {.importcpp: "wxEVT_ENTER_WINDOW", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxMouseEvent]

var wxEVT_LEAVE_WINDOW* {.importcpp: "wxEVT_LEAVE_WINDOW", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxMouseEvent]

var wxEVT_LEFT_DCLICK* {.importcpp: "wxEVT_LEFT_DCLICK", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxMouseEvent]

var wxEVT_MIDDLE_DCLICK* {.importcpp: "wxEVT_MIDDLE_DCLICK", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxMouseEvent]

var wxEVT_RIGHT_DCLICK* {.importcpp: "wxEVT_RIGHT_DCLICK", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxMouseEvent]

var wxEVT_SET_FOCUS* {.importcpp: "wxEVT_SET_FOCUS", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxFocusEvent]

var wxEVT_KILL_FOCUS* {.importcpp: "wxEVT_KILL_FOCUS", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxFocusEvent]

var wxEVT_CHILD_FOCUS* {.importcpp: "wxEVT_CHILD_FOCUS", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxChildFocusEvent]

var wxEVT_MOUSEWHEEL* {.importcpp: "wxEVT_MOUSEWHEEL", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxMouseEvent]

var wxEVT_AUX1DOWN* {.importcpp: "wxEVT_AUX1_DOWN", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxMouseEvent]

var wxEVT_AUX1UP* {.importcpp: "wxEVT_AUX1_UP", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxMouseEvent]

var wxEVT_AUX1DCLICK* {.importcpp: "wxEVT_AUX1_DCLICK", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxMouseEvent]

var wxEVT_AUX2DOWN* {.importcpp: "wxEVT_AUX2_DOWN", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxMouseEvent]

var wxEVT_AUX2UP* {.importcpp: "wxEVT_AUX2_UP", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxMouseEvent]

var wxEVT_AUX2DCLICK* {.importcpp: "wxEVT_AUX2_DCLICK", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxMouseEvent]


var wxEVT_CHAR* {.importcpp: "wxEVT_CHAR", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxKeyEvent]

var wxEVT_CHAR_HOOK* {.importcpp: "wxEVT_CHAR_HOOK", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxKeyEvent]

var wxEVT_NAVIGATION_KEY* {.importcpp: "wxEVT_NAVIGATION_KEY", 
                            header: "<wx/wx.h>".}: WxEventTypeTag[
    WxNavigationKeyEvent]

var wxEVT_KEY_DOWN* {.importcpp: "wxEVT_KEY_DOWN", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxKeyEvent]

var wxEVT_KEY_UP* {.importcpp: "wxEVT_KEY_UP", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxKeyEvent]

var wxEVT_HOTKEY* {.importcpp: "wxEVT_HOTKEY", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxKeyEvent]


var wxEVT_AFTER_CHAR* {.importcpp: "wxEVT_AFTER_CHAR", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxKeyEvent]


var wxEVT_SET_CURSOR* {.importcpp: "wxEVT_SET_CURSOR", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxSetCursorEvent]


var wxEVT_SCROLL_TOP* {.importcpp: "wxEVT_SCROLL_TOP", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxScrollEvent]

var wxEVT_SCROLL_BOTTOM* {.importcpp: "wxEVT_SCROLL_BOTTOM", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxScrollEvent]

var wxEVT_SCROLL_LINEUP* {.importcpp: "wxEVT_SCROLL_LINEUP", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxScrollEvent]

var wxEVT_SCROLL_LINEDOWN* {.importcpp: "wxEVT_SCROLL_LINEDOWN", 
                             header: "<wx/wx.h>".}: WxEventTypeTag[WxScrollEvent]

var wxEVT_SCROLL_PAGEUP* {.importcpp: "wxEVT_SCROLL_PAGEUP", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxScrollEvent]

var wxEVT_SCROLL_PAGEDOWN* {.importcpp: "wxEVT_SCROLL_PAGEDOWN", 
                             header: "<wx/wx.h>".}: WxEventTypeTag[WxScrollEvent]
...
var wxEVT_SCROLL_CHANGED* {.importcpp: "wxEVT_SCROLL_CHANGED", 
                            header: "<wx/wx.h>".}: WxEventTypeTag[WxScrollEvent]


var wxEVT_SPIN_UP* {.importcpp: "wxEVT_SPIN_UP", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxSpinEvent]

var wxEVT_SPIN_DOWN* {.importcpp: "wxEVT_SPIN_DOWN", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxSpinEvent]

var wxEVT_SPIN* {.importcpp: "wxEVT_SPIN", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxSpinEvent]


var wxEVT_SCROLLWIN_TOP* {.importcpp: "wxEVT_SCROLLWIN_TOP", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxScrollWinEvent]
...
var wxEVT_SIZE* {.importcpp: "wxEVT_SIZE", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxSizeEvent]

var wxEVT_MOVE* {.importcpp: "wxEVT_MOVE", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxMoveEvent]

var wxEVT_CLOSE_WINDOW* {.importcpp: "wxEVT_CLOSE_WINDOW", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxCloseEvent]

var wxEVT_END_SESSION* {.importcpp: "wxEVT_END_SESSION", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxCloseEvent]
...
var wxEVT_ACTIVATE_APP* {.importcpp: "wxEVT_ACTIVATE_APP", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxActivateEvent]

var wxEVT_ACTIVATE* {.importcpp: "wxEVT_ACTIVATE", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxActivateEvent]

var wxEVT_CREATE* {.importcpp: "wxEVT_CREATE", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxWindowCreateEvent]

var wxEVT_DESTROY* {.importcpp: "wxEVT_DESTROY", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxWindowDestroyEvent]

var wxEVT_SHOW* {.importcpp: "wxEVT_SHOW", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxShowEvent]

var wxEVT_ICONIZE* {.importcpp: "wxEVT_ICONIZE", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxIconizeEvent]

var wxEVT_MAXIMIZE* {.importcpp: "wxEVT_MAXIMIZE", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxMaximizeEvent]
...
var wxEVT_PAINT* {.importcpp: "wxEVT_PAINT", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxPaintEvent]

var wxEVT_ERASE_BACKGROUND* {.importcpp: "wxEVT_ERASE_BACKGROUND", 
                              header: "<wx/wx.h>".}: WxEventTypeTag[WxEraseEvent]

var wxEVT_NC_PAINT* {.importcpp: "wxEVT_NC_PAINT", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxNcPaintEvent]

var wxEVT_MENU_OPEN* {.importcpp: "wxEVT_MENU_OPEN", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxMenuEvent]

var wxEVT_MENU_CLOSE* {.importcpp: "wxEVT_MENU_CLOSE", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxMenuEvent]

var wxEVT_MENU_HIGHLIGHT* {.importcpp: "wxEVT_MENU_HIGHLIGHT", 
                            header: "<wx/wx.h>".}: WxEventTypeTag[WxMenuEvent]

var wxEVT_CONTEXT_MENU* {.importcpp: "wxEVT_CONTEXT_MENU", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxContextMenuEvent]
...
var wxEVT_DISPLAY_CHANGED* {.importcpp: "wxEVT_DISPLAY_CHANGED", 
                             header: "<wx/wx.h>".}: WxEventTypeTag[
...
var wxEVT_PALETTE_CHANGED* {.importcpp: "wxEVT_PALETTE_CHANGED", 
                             header: "<wx/wx.h>".}: WxEventTypeTag[
    WxPaletteChangedEvent]

var wxEVT_JOY_BUTTON_DOWN* {.importcpp: "wxEVT_JOY_BUTTON_DOWN", 
                             header: "<wx/wx.h>".}: WxEventTypeTag[
    WxJoystickEvent]

var wxEVT_JOY_BUTTON_UP* {.importcpp: "wxEVT_JOY_BUTTON_UP", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxJoystickEvent]

var wxEVT_JOY_MOVE* {.importcpp: "wxEVT_JOY_MOVE", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxJoystickEvent]

var wxEVT_JOY_ZMOVE* {.importcpp: "wxEVT_JOY_ZMOVE", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxJoystickEvent]

var wxEVT_DROP_FILES* {.importcpp: "wxEVT_DROP_FILES", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxDropFilesEvent]

var wxEVT_INIT_DIALOG* {.importcpp: "wxEVT_INIT_DIALOG", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxInitDialogEvent]

var wxEVT_IDLE* {.importcpp: "wxEVT_IDLE", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxIdleEvent]

var wxEVT_UPDATE_UI* {.importcpp: "wxEVT_UPDATE_UI", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxUpdateUIEvent]

var wxEVT_SIZING* {.importcpp: "wxEVT_SIZING", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxSizeEvent]

var wxEVT_MOVING* {.importcpp: "wxEVT_MOVING", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxMoveEvent]

var wxEVT_MOVE_START* {.importcpp: "wxEVT_MOVE_START", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxMoveEvent]

var wxEVT_MOVE_END* {.importcpp: "wxEVT_MOVE_END", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxMoveEvent]

var wxEVT_HIBERNATE* {.importcpp: "wxEVT_HIBERNATE", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxActivateEvent]


var wxEVT_TEXT_COPY* {.importcpp: "wxEVT_TEXT_COPY", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxClipboardTextEvent]

var wxEVT_TEXT_CUT* {.importcpp: "wxEVT_TEXT_CUT", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxClipboardTextEvent]

var wxEVT_TEXT_PASTE* {.importcpp: "wxEVT_TEXT_PASTE", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxClipboardTextEvent]
...
var wxEVT_COMMAND_ENTER* {.importcpp: "wxEVT_COMMAND_ENTER", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxCommandEvent]


var wxEVT_HELP* {.importcpp: "wxEVT_HELP", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxHelpEvent]

var wxEVT_DETAILED_HELP* {.importcpp: "wxEVT_DETAILED_HELP", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxHelpEvent]


template wxEVT_TOOL*: expr = wxEVT_MENU
var wxEVT_TEXT* {.importcpp: "wxEVT_TEXT", header: "<wx/wx.h>".}: WxEventTypeTag[
    WxCommandEvent]
