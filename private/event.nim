...
proc constructwxThreadEvent*(eventType: WxEventType; id: auto = wxID_ANY): WxThreadEvent {.
...
proc disconnect*(this: var WxEvtHandler; winid: auto = wxID_ANY; 
...
proc `bind`*[EventTag, Functor](this: var WxEvtHandler; eventType: EventTag; 
                                functor: Functor; winid: auto = wxID_ANY; 
                                lastId: auto = wxID_ANY; 
                                userData: ptr WxObject = nil) {.cdecl, 
    importcpp: "Bind", header: "wx.h".}
...
proc `bind`*[EventTag, Class, EventArg, EventHandler](this: var WxEvtHandler; 
    ...
    winid: auto = wxID_ANY; lastId: auto = wxID_ANY; 
