...
type 
  WxTopLevelWindow* {.importcpp: "wxTopLevelWindow", header: "<wx/wx.h>".} = object of WxWindow
  

var wxDEFAULT_FRAME_STYLE* {.importcpp: "wxDEFAULT_FRAME_STYLE", 
                             header: "<wx/wx.h>".}: clong

var wxFULLSCREEN_ALL* {.importcpp: "wxFULLSCREEN_ALL", header: "<wx/wx.h>".}: clong
...
type 
  WxFrameBase* {.importcpp: "wxFrameBase", header: "<wx/wx.h>".} = object of WxTopLevelWindow
  

proc constructwxFrameBase*(): WxFrameBase {.cdecl, constructor, 
    importcpp: "wxFrameBase(@)", header: "<wx/wx.h>".}
...
proc setMenuBar*(this: var WxFrameBase; menubar: ptr WxMenuBar) {.cdecl, 
    importcpp: "SetMenuBar", header: "<wx/wx.h>".}
...
proc findItemInMenuBar*(this: WxFrameBase; menuId: cint): ptr WxMenuItem {.
    noSideEffect, cdecl, importcpp: "FindItemInMenuBar", header: "<wx/wx.h>".}
...
proc setStatusBarPane*(this: var WxFrameBase; n: cint) {.cdecl, 
    importcpp: "SetStatusBarPane", header: "<wx/wx.h>".}
proc getStatusBarPane*(this: WxFrameBase): cint {.noSideEffect, cdecl, 
    importcpp: "GetStatusBarPane", header: "<wx/wx.h>".}
...
proc doGiveHelp*(this: var WxFrameBase; text: WxString; show: bool) {.cdecl, 
    importcpp: "DoGiveHelp", header: "<wx/wx.h>".}
...
type 
  WxFrame* {.importcpp: "wxFrame", header: "<wx/wx.h>".} = object of WxFrameBase
...
proc constructwxFrame*(parent: ptr WxWindow; id: WxWindowID; title: WxString; 
    ...
    cdecl, constructor, importcpp: "wxFrame(@)", header: "<wx/wx.h>".}
...
proc showFullScreen*(this: var WxFrame; show: bool; 
    ...
    importcpp: "ShowFullScreen", header: "<wx/wx.h>".}
...
proc useNativeStatusBar*(useNative: bool) {.cdecl, 
    importcpp: "wxFrame::UseNativeStatusBar(@)", header: "<wx/wx.h>".}
