...
type 
  WxDatePickerCtrlBase* {.importcpp: "wxDatePickerCtrlBase", header: "wx.h".} = object of WxDateTimePickerCtrl
  

proc setRange*(this: var WxDatePickerCtrlBase; dt1: WxDateTime; dt2: WxDateTime) {.
    cdecl, importcpp: "SetRange", header: "wx.h".}
...
type 
  WxDatePickerCtrl* {.importcpp: "wxDatePickerCtrl", header: "wx.h".} = object of WxDatePickerCtrlBase
  

proc constructwxDatePickerCtrl*(): WxDatePickerCtrl {.cdecl, constructor, 
    importcpp: "wxDatePickerCtrl(@)", header: "wx.h".}
proc constructwxDatePickerCtrl*(parent: ptr WxWindow; id: WxWindowID; 
    ...
    cdecl, constructor, importcpp: "wxDatePickerCtrl(@)", header: "wx.h".}