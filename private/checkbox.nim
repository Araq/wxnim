...
type 
  WxCheckBoxBase* {.importcpp: "wxCheckBoxBase", header: "wx.h".} = object of WxControl
  

proc constructwxCheckBoxBase*(): WxCheckBoxBase {.cdecl, constructor, 
    importcpp: "wxCheckBoxBase(@)", header: "wx.h".}
...
type 
  WxCheckBox* {.importcpp: "wxCheckBox", header: "wx.h".} = object of WxCheckBoxBase
  

proc constructwxCheckBox*(): WxCheckBox {.cdecl, constructor, 
    importcpp: "wxCheckBox(@)", header: "wx.h".}
proc constructwxCheckBox*(parent: ptr WxWindow; id: WxWindowID; label: WxString; 
    ...
    cdecl, constructor, importcpp: "wxCheckBox(@)", header: "wx.h".}
