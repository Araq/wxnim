...
type 
  Alignment_3260276896* {.importcpp: "no_name", header: "wx.h".} = object  {.
      union.}
    mInt64* {.importc: "m_int64".}: WxInt64
    mLongDouble* {.importc: "m_longDouble".}: clongdouble
    mFuncPtr* {.importc: "m_funcPtr".}: proc () {.cdecl.}

  WxAnyValueBuffer* {.importcpp: "wxAnyValueBuffer", header: "wx.h".} = object  {.
      union.}
...
type 
  WxAnyValueType* {.importcpp: "wxAnyValueType", header: "wx.h", inheritable.} = object 
  

proc constructwxAnyValueType*(): WxAnyValueType {.cdecl, constructor, 
    importcpp: "wxAnyValueType(@)", header: "wx.h".}
...
type 
  WxAnyValueTypeImplBase* {.importcpp: "wxAnyValueTypeImplBase", header: "wx.h".}[
      T] = object of WxAnyValueType
  

proc constructwxAnyValueTypeImplBase*[T](): WxAnyValueTypeImplBase[T] {.cdecl, 
    constructor, importcpp: "wxAnyValueTypeImplBase(@)", header: "wx.h".}
proc destroywxAnyValueTypeImplBase*[T](this: var WxAnyValueTypeImplBase[T]) {.
    cdecl, importcpp: "#.~wxAnyValueTypeImplBase()", header: "wx.h".}
...
proc setValue*[T](value: T; buf: var WxAnyValueBuffer) {.cdecl, 
    importcpp: "wxAnyValueTypeImplBase::SetValue(@)", header: "wx.h".}
proc getValue*[T](buf: WxAnyValueBuffer): T {.cdecl, 
    importcpp: "wxAnyValueTypeImplBase::GetValue(@)", header: "wx.h".}

type 
  WxAnyValueTypeImpl* {.importcpp: "wxAnyValueTypeImpl", header: "wx.h".}[T] = object of WxAnyValueTypeImplBase[
      T]
...
proc constructwxAnyValueTypeImpl*[T](): WxAnyValueTypeImpl[T] {.cdecl, 
    constructor, importcpp: "wxAnyValueTypeImpl(@)", header: "wx.h".}
proc destroywxAnyValueTypeImpl*[T](this: var WxAnyValueTypeImpl[T]) {.cdecl, 
    importcpp: "#.~wxAnyValueTypeImpl()", header: "wx.h".}
...
type 
  WxAnyValueTypeImplInt* {.importcpp: "wxAnyValueTypeImplInt", header: "wx.h".} = object of WxAnyValueTypeImplBase[
      WxAnyBaseIntType]
...
proc constructwxAnyValueTypeImplInt*(): WxAnyValueTypeImplInt {.cdecl, 
    constructor, importcpp: "wxAnyValueTypeImplInt(@)", header: "wx.h".}
proc destroywxAnyValueTypeImplInt*(this: var WxAnyValueTypeImplInt) {.cdecl, 
    importcpp: "#.~wxAnyValueTypeImplInt()", header: "wx.h".}
proc convertValue*(this: WxAnyValueTypeImplInt; src: WxAnyValueBuffer; 
                   dstType: ptr WxAnyValueType; dst: var WxAnyValueBuffer): bool {.
    noSideEffect, cdecl, importcpp: "ConvertValue", header: "wx.h".}
type 
  WxAnyValueTypeImplUint* {.importcpp: "wxAnyValueTypeImplUint", header: "wx.h".} = object of WxAnyValueTypeImplBase[
      WxAnyBaseUintType]
...
proc constructwxAnyValueTypeImplUint*(): WxAnyValueTypeImplUint {.cdecl, 
    constructor, importcpp: "wxAnyValueTypeImplUint(@)", header: "wx.h".}
proc destroywxAnyValueTypeImplUint*(this: var WxAnyValueTypeImplUint) {.cdecl, 
    importcpp: "#.~wxAnyValueTypeImplUint()", header: "wx.h".}
...
proc wxAnyConvertString*(value: WxString; dstType: ptr WxAnyValueType; 
    ...
    importcpp: "wxAnyConvertString(@)", header: "wx.h".}
...
type 
  WxAny* {.importcpp: "wxAny", header: "wx.h".} = object 
    mBuffer* {.importc: "m_buffer".}: WxAnyValueBuffer
    mType* {.importc: "m_type".}: ptr WxAnyValueType
...
proc hasSameType*(this: WxAny; other: WxAny): bool {.noSideEffect, cdecl, 
    importcpp: "HasSameType", header: "wx.h".}
proc isNull*(this: WxAny): bool {.noSideEffect, cdecl, importcpp: "IsNull", 
                                  header: "wx.h".}
proc makeNull*(this: var WxAny) {.cdecl, importcpp: "MakeNull", header: "wx.h".}
