...
#define wxHL_ALIGN_CENTER       0x0008
#define wxHL_DEFAULT_STYLE      (wxHL_CONTEXTMENU|int(wxNO_BORDER)|wxHL_ALIGN_CENTER)
...
// ----------------------------------------------------------------------------
    ...
    class WXDLLIMPEXP_ADV wxHyperlinkCtrl : public wxHyperlinkCtrlBase
    {
    public:
        wxHyperlinkCtrl() { }
        ...
        wxHyperlinkCtrl(wxWindow *parent,
            ...
            : wxHyperlinkCtrlBase(parent, id, label, url, pos, size,
                                     style, name)
        {
        }
    };
