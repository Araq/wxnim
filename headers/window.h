...
enum wxWindowVariant
{
    ...
    #define wxWINDOW_DEFAULT_VARIANT "window-default-variant"
#endif
...
class WXDLLIMPEXP_CORE wxRegion: public wxObject {};
class WXDLLIMPEXP_CORE wxAcceleratorTable: public wxObject {};
class WXDLLIMPEXP_CORE wxToolTip: public wxObject {};
class WXDLLIMPEXP_CORE wxScrollHelper: public wxObject {};
class WXDLLIMPEXP_CORE wxRenderer: public wxObject {};
...
public:
    ...
    void Centre(auto dir = wxBOTH) { DoCentre(dir); }
    void Center(auto dir = wxBOTH) { DoCentre(dir); }

        // centre with respect to the parent window
    void CentreOnParent(auto dir = wxBOTH) { DoCentre(dir); }
    void CenterOnParent(auto dir = wxBOTH) { CentreOnParent(dir); }
...
public:
    ...
    virtual void SetBackground(const wxBitmap& bitmap,
                               auto alignment = wxALIGN_CENTER,
                               wxStretch stretch = wxSTRETCH_NOT);

    const wxBitmap& GetBackgroundBitmap(wxAlignment *alignment = NULL,
