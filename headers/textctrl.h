...
enum wxTextAttrFlags
{
    ...
    wxTEXT_ATTR_FONT_SIZE =            0x10000008,

    wxTEXT_ATTR_FONT =
        ( 4 | 0x10000008
        | 0x00000010 |
        0x20 | 0x40 |
        0x08000000 | 0x02000000 | 0x04000000),

/*
    wxTEXT_ATTR_CHARACTER =
        (wxTEXT_ATTR_FONT|wxTEXT_ATTR_EFFECTS|
         wxTEXT_ATTR_BACKGROUND_COLOUR|wxTEXT_ATTR_TEXT_COLOUR|
         wxTEXT_ATTR_CHARACTER_STYLE_NAME|wxTEXT_ATTR_URL),

    wxTEXT_ATTR_PARAGRAPH =
        (wxTEXT_ATTR_ALIGNMENT|wxTEXT_ATTR_LEFT_INDENT|
         wxTEXT_ATTR_RIGHT_INDENT|wxTEXT_ATTR_TABS|
            wxTEXT_ATTR_PARA_SPACING_BEFORE|wxTEXT_ATTR_PARA_SPACING_AFTER|
            wxTEXT_ATTR_LINE_SPACING|
            wxTEXT_ATTR_BULLET|wxTEXT_ATTR_PARAGRAPH_STYLE_NAME|
            wxTEXT_ATTR_LIST_STYLE_NAME|wxTEXT_ATTR_OUTLINE_LEVEL|
...
public:
    ...
    bool GetFontAttributes(const wxFont& font, auto flags = wxTEXT_ATTR_FONT);
    ...
    // Set font
    void SetFont(const wxFont& font) { GetFontAttributes(font, flags); }
...
#def wx__DECLARE_TEXTEVT(evt, id, fn) \
    wx__DECLARE_EVT1(wxEVT_TEXT_ ## evt, id, wxTextEventHandler(fn))

#def wx__DECLARE_TEXTURLEVT(evt, id, fn) \
