...
#def wxWebViewDefaultURLStr constructWxString("about:blank")
#def wxWebViewNameStr constructWxString("wxWebView")
#def wxWebViewBackendDefault constructWxString("wxWebViewWebKit")
// wxWebViewIE
...
/*    void SetPage(wxInputStream& html, wxString baseUrl)
    ...
    //Find function
    virtual long Find(const wxString& text, auto flags = wxWEBVIEW_FIND_DEFAULT) = 0;
};
