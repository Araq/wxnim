...
#define SYMBOL_WXSYMBOLPICKERDIALOG_TITLE() "Symbols"
#define SYMBOL_WXSYMBOLPICKERDIALOG_IDNAME() {.WxWindowID(ID_SYMBOLPICKERDIALOG).}
#define SYMBOL_WXSYMBOLPICKERDIALOG_SIZE() constructWxSize(400, 300)
...
class WXDLLIMPEXP_RICHTEXT wxSymbolListCtrl : public wxWindow
{
public:
