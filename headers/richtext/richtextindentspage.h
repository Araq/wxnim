...
#define SYMBOL_WXRICHTEXTINDENTSSPACINGPAGE_IDNAME() {.WxWindowID(ID_RICHTEXTINDENTSSPACINGPAGE).}
#define SYMBOL_WXRICHTEXTINDENTSSPACINGPAGE_SIZE() constructWxSize(400, 300)
