...
class WXDLLIMPEXP_RICHTEXT wxRichTextFormattingDialog: public wxDialog,
                                                       public wxWithImages
{
...
public:
    ...
    wxRichTextFormattingDialog(long flags, wxWindow* parent, const wxString& title = "Formatting", wxWindowID id = wxID_ANY,
    ...
    bool Create(long flags, wxWindow* parent, const wxString& title = "Formatting", wxWindowID id = wxID_ANY,
        const wxPoint& pos = wxDefaultPosition, const wxSize& sz = wxDefaultSize,
        long style = wxDEFAULT_DIALOG_STYLE);
...
class WXDLLIMPEXP_RICHTEXT wxRichTextFontListBox: public wxListBox
{
public:
