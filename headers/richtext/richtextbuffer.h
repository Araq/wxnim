...
#inheritable wxArrayPtrVoid
class wxArrayPtrVoid {};
#inheritable wxCommand
class wxCommand {};
...
typedef  wxTextAttr wxTextAttrEx;
...
public:
    ...
    */
    int GetPixels(const wxTextAttrDimension& dim, auto direction = wxHORIZONTAL) const;
    /**
...
#define wxRICHTEXT_ALL()  constructWxRichTextRange(-2, -2)
#define wxRICHTEXT_NONE()  constructWxRichTextRange(-1, -1)

#define wxRICHTEXT_NO_SELECTION() constructWxRichTextRange(-2, -2)
...
// Overridables
    ...
    */
    ...
    virtual bool GetRangeSize(const wxRichTextRange& range, wxSize& size, int& descent, wxDC& dc, wxRichTextDrawingContext& context, int flags, const wxPoint& position= {.constructWxPoint(0,0).}, const wxSize& parentSize = wxDefaultSize, wxArrayInt* partialExtents = NULL) const  = 0;
...
// Overridables
    ...
    virtual bool GetRangeSize(const wxRichTextRange& range, wxSize& size, int& descent, wxDC& dc, wxRichTextDrawingContext& context, int flags, const wxPoint& position= {.constructWxPoint(0,0).}, const wxSize& parentSize = wxDefaultSize, wxArrayInt* partialExtents = NULL) const;
...
public:
    ...
    */
    ...
    /**
        ...
        is invalid for this object.
    */
    virtual bool GetRangeSize(wxRichTextField* obj, const wxRichTextRange& range, wxSize& size, int& descent, wxDC& dc, wxRichTextDrawingContext& context, int flags, const wxPoint& position= {.constructWxPoint(0,0).}, const wxSize& parentSize = wxDefaultSize, wxArrayInt* partialExtents = NULL) const = 0;
...
public:
    ...
    */
    ...
    /**
        ...
        is invalid for this object.
    */
    virtual bool GetRangeSize(wxRichTextField* obj, const wxRichTextRange& range, wxSize& size, int& descent, wxDC& dc, wxRichTextDrawingContext& context, int flags, const wxPoint& position= {.constructWxPoint(0,0).}, const wxSize& parentSize = wxDefaultSize, wxArrayInt* partialExtents = NULL) const;
...
// Operations
    ...
    */
    bool BeginSymbolBullet(const wxString& symbol, int leftIndent, int leftSubIndent);
...
// Operations
    ...
    */
    ...
    virtual bool AddRows(int startRow, int noRows = 1, const wxRichTextAttr& attr = constructWxRichTextAttr());

    /**
        Adds columns from the given column position.
    */

    virtual bool AddColumns(int startCol, int noCols = 1, const wxRichTextAttr& attr = constructWxRichTextAttr());
