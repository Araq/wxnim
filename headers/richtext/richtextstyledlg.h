 ...
 * Control identifiers
 */
extern long wxSYSTEM_MENU;
extern long wxCLOSE_BOX;

#define SYMBOL_WXRICHTEXTSTYLEORGANISERDIALOG_STYLE() wxDEFAULT_DIALOG_STYLE|wxRESIZE_BORDER|wxSYSTEM_MENU|wxCLOSE_BOX
#define SYMBOL_WXRICHTEXTSTYLEORGANISERDIALOG_TITLE() "Style Organiser"
#define SYMBOL_WXRICHTEXTSTYLEORGANISERDIALOG_IDNAME() {.WxWindowID(ID_RICHTEXTSTYLEORGANISERDIALOG).}
#define SYMBOL_WXRICHTEXTSTYLEORGANISERDIALOG_SIZE() constructWxSize(400, 300)
